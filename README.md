...
```
RESEARCH → SOLUTIONS → PATHWAYS → FINANCE → OUTCOMES
```

**Research and evidence** — cross-sectoral partnerships between peak bodies and research organisations

**Solutions** — split into two arms:
- *Technical* — evidence-based solutions: what gets built and deployed
- *Adaptive* — First Nations governance, co-design, cultural safety, two-way learning, leadership: how change actually lands
- *Startup pipeline* — tech and social ventures entering the system at either arm

**Pathways** — how solutions reach communities: community-controlled organisations, policy, system reform, workforce, Country-based pathways, cross-sector partnerships

**Finance and ecosystem** — government (non-dilutive), philanthropy, First Nations-controlled capital, impact investing, outcomes-based finance, blended finance, startup finance pathways
...
- Claude API (Anthropic) — embedded AI navigation
- GitHub Pages — free, open hosting

---

*Built by a researcher and Claude (Anthropic), June 2026.*
*First Nations Health and Equity — Western Australia. Version 0.1.*
